...
with open("laws_n_regs.txt", "r", encoding="utf-8") as file:
    example_contract_text4 = file.read()
with open("signature.txt", "r", encoding="utf-8") as file:
    example_contract_text5 = file.read()
with open("privacy_notice.txt", "r", encoding="utf-8") as file:
    example_contract_text6 = file.read()
with open("withdrawal.txt", "r", encoding="utf-8") as file:
...
async def autocv_request(
    ...
    with open("Assunzione.txt", "w", encoding="utf-8") as f:
        f.write(current_cv)
    print("Documento salvato su Assunzione.txt")
